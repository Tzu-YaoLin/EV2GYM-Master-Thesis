# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 19:59:18 2024
...
# 初始化 SAC 模型
model = SAC('MlpPolicy', vec_env, learning_rate=LR, batch_size=BATCH_SIZE, gamma=GAMMA, verbose=1, tensorboard_log="./sac_ev2gym_tensorboard/", device=device)

# 訓練模型
model.learn(total_timesteps=100000, log_interval=10)

# 保存模型
model.save("sac_ev2gym_model")
