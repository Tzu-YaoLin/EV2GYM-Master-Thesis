...
# # 計算電價數據的均值和標準差
# price_mean = df_prices_germany['Germany/Luxembourg [€/MWh] Original resolutions'].mean()
# price_std = df_prices_germany['Germany/Luxembourg [€/MWh] Original resolutions'].std()
...
# # 進行標準化
# df_prices_germany['Germany/Luxembourg [€/MWh] Original resolutions'] = (
#     df_prices_germany['Germany/Luxembourg [€/MWh] Original resolutions'] - price_mean
# ) / price_std
